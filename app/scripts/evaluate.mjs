...
const cases = [
  ...
  ...expand("multi", "Do not hire another engineer before launch", ["Why can’t we hire another engineer before launch?","Why is hiring an engineer blocked before launch?","Can we hire an engineer before launch?","Explain the engineer hiring constraint before launch","Why must hiring wait until launch?","What blocks another engineering hire before launch?"]),
